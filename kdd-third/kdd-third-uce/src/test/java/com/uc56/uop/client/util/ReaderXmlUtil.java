...
public class ReaderXmlUtil {
	...
	private static final String path_xml_file = "src/test/java/com/uc56/uop/client/xml/XmlFile.xml";
	private static final String path_json_file = "src/test/java/com/uc56/uop/client/xml/JsonFile.xml";
