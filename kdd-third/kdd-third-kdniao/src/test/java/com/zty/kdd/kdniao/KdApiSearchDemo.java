...
public class KdApiSearchDemo {
    ...
    private String EBusinessID="1702726";//即用户ID，登录快递鸟官网会员中心获取 https://www.kdniao.com/UserCenter/v4/UserHome.aspx
    //API key，快递鸟提供，注意保管，不要泄漏
    private String ApiKey="ce70fd04-8862-403f-82c6-f06f72ea6f4f";//即API key，登录快递鸟官网会员中心获取 https://www.kdniao.com/UserCenter/v4/UserHome.aspx
    //请求url, 正式环境地址
...
//    private String ReqURL="http://sandboxapi.kdniao.com:8080/kdniaosandbox/gateway/exterfaceInvoke.json";
    ...
    public String orderOnlineByJson() throws Exception{
        ...
        String RequestData= "{"+
                ...
                "'OrderCode': '',"+
                "'ShipperCode': 'SF',"+
                "'LogisticCode': 'SF1331455032550',"+
                "}";
//        String RequestData= "{"+
//                "'CustomerName': '',"+
//                "'OrderCode': '',"+
//                "'ShipperCode': 'STO',"+
//                "'LogisticCode': '233823364856',"+
//                "}";
//        String RequestData= "{"+
//                "'CustomerName': '',"+
//                "'OrderCode': '',"+
//                "'ShipperCode': 'YTO',"+
//                "'LogisticCode': 'YT3171192665038',"+
//                "}";
        // 组装系统级参数
