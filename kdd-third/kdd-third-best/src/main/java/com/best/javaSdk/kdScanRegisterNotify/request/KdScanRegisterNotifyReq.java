package com.best.javaSdk.kdScanRegisterNotify.request;
...
public class KdScanRegisterNotifyReq implements BaseRequest {
    ...
    public BaseResponse makeResponse(String rsp, String format) {
        if ("xml".equalsIgnoreCase(format)) {
			return Parser.coverXml2Object(rsp, com.best.javaSdk.kdScanRegisterNotify.response.KdScanRegisterNotifyRsp.class);
		}
		return Parser.convertJson2Object(rsp, com.best.javaSdk.kdScanRegisterNotify.response.KdScanRegisterNotifyRsp.class);
